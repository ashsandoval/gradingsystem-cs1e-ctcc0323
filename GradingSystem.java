...
// Class for handling the background panel with an image
...
public class GradingSystem extends JFrame {
    ...
    public GradingSystem() {
        ...
        createGradingPanel();  // Create the grading panel

        add(loginPanel);
        add(gradingPanel);

        gradingPanel.setVisible(false);           // Hide grading panel initially
    ...
    private void createLoginPanel() {
        ...
        // Use the BackgroundPanel for the login panel   
        loginPanel = new BackgroundPanel("bpsu3.jpg");
        loginPanel.setLayout(null);
        loginPanel.setBounds(0, 0, 1200, 800);
        // Add and resize logo image
            ...
            public void actionPerformed(ActionEvent e) {
               ...
               // Check credentials
                if (username.equals("admin") && password.equals("admin")) {
                    changePageToDebug();  // Switch to grading panel if credentials are correct
                } else {
       ...
       // Method to create the grading panel
     ...
     // Add labels and text fields for student information            
       ...
       // Add compute grades button and its action listener
        ...
        // Add OK button and its action listener 
      ...
      // Setup table to display results
       ...
       // Add and resize logo image for grading panel    
         ImageIcon originalIcon = new ImageIcon("bpsu.png");
    ...
    // Method to switch from login panel to grading panel
    private void changePageToDebug() {
        loginPanel.setVisible(false);
        gradingPanel.setVisible(true);
        gradingPanel.repaint(); 
    }
    // Listener class for computing grades
    ...
    // Listener class for OK button to reset fields
   ...
   // Method to calculate the average grade from scores
   ...
   // Method to get the grade description based on the grade
   ...
   // Method to get the equivalent grade based on the grade
